...
def fallback_response(
    ...
    # ── Face ──────────────────────────────────────────────────
    face_looks = {
        "wedding":    {"foundation": "full coverage ivory beige", "concealer": "one shade lighter under eyes", "blush": "soft rose pink", "blush_hex": "#D4707F", "highlight": "champagne gold on cheekbones", "contour": "soft brown along jawline", "primer": "smoothing primer", "setting": "translucent powder + setting spray", "tip": "set with translucent powder for all-day wear"},
        "mehndi":     {"foundation": "light dewy coverage", "concealer": "peachy nude under eyes", "blush": "bright coral", "blush_hex": "#E86F58", "highlight": "golden shimmer on cheekbones", "contour": "light taupe along sides of nose", "primer": "hydrating primer", "setting": "dewy setting spray", "tip": "keep skin glowing and fresh for mehndi pictures"},
        "dholki":     {"foundation": "medium coverage", "concealer": "light peach under eyes", "blush": "hot pink", "blush_hex": "#E0487C", "highlight": "pink shimmer", "contour": "soft brown along jawline", "primer": "colour-correcting primer", "setting": "long-wear setting spray", "tip": "be bold — dholki is for fun colourful looks"},
        "eid":        {"foundation": "light satin coverage", "concealer": "nude beige under eyes", "blush": "peach pink", "blush_hex": "#E5827D", "highlight": "soft gold", "contour": "skip", "primer": "hydrating primer", "setting": "satin setting spray", "tip": "keep it elegant and fresh for Eid visits"},
        "party":      {"foundation": "full matte coverage", "concealer": "light under eyes", "blush": "deep rose sculpted", "blush_hex": "#C2526E", "highlight": "blinding gold on cheekbones", "contour": "deep taupe for sharp sculpt", "primer": "pore-minimising primer", "setting": "translucent powder + long-wear spray", "tip": "set everything with setting spray before going out"},
        "university": {"foundation": "light BB cream", "concealer": "light peach under eyes", "blush": "soft baby pink", "blush_hex": "#F4A6B6", "highlight": "subtle pearl", "contour": "skip", "primer": "lightweight primer", "setting": "light setting powder", "tip": "keep it minimal and fresh for daytime"},
        "office":     {"foundation": "medium matte coverage", "concealer": "light nude under eyes", "blush": "soft mauve", "blush_hex": "#BD7B89", "highlight": "subtle champagne", "contour": "skip", "primer": "smoothing primer", "setting": "translucent powder", "tip": "keep it neat and professional"},
        "everyday":   {"foundation": "light tinted moisturiser", "concealer": "light peach where needed", "blush": "soft peach", "blush_hex": "#EB9884", "highlight": "subtle glow", "contour": "skip for everyday", "primer": "SPF moisturiser", "setting": "light setting spray", "tip": "just enhance your natural features"},
        "date":       {"foundation": "medium satin coverage", "concealer": "light peach under eyes", "blush": "soft coral", "blush_hex": "#E57C72", "highlight": "champagne gold", "contour": "light bronze along jawline", "primer": "hydrating primer", "setting": "satin setting spray", "tip": "a soft glow always looks romantic"},
    }

    # ── Eyes ──────────────────────────────────────────────────
    eyes_looks = {
        "wedding":    {"eyeshadow": "golden brown on lid, champagne on brow bone", "eyeshadow_hex": "#9E784F", "eyeliner": "black kajal in waterline + black gel liner on upper lash line", "eyeliner_hex": "#1A1A1A", "mascara": "volumising black mascara", "brows": "defined arch filled with dark brown", "tip": "apply eyeshadow primer for long-lasting wear"},
        "mehndi":     {"eyeshadow": "bright green or yellow shimmer on lid", "eyeshadow_hex": "#8B8C3A", "eyeliner": "black kajal in waterline + thick black liner", "eyeliner_hex": "#151515", "mascara": "volumising black mascara", "brows": "bold filled brows", "tip": "use colourful liner to match your outfit"},
        "dholki":     {"eyeshadow": "purple or pink shimmer on lid", "eyeshadow_hex": "#8E4A7D", "eyeliner": "black kajal + colourful or black winged liner", "eyeliner_hex": "#1A1A1A", "mascara": "volumising black mascara", "brows": "bold brows", "tip": "go bold and colourful — have fun with it"},
        "eid":        {"eyeshadow": "copper brown on lid, nude on brow bone", "eyeshadow_hex": "#A46643", "eyeliner": "black kajal in waterline + thin black liner", "eyeliner_hex": "#1C1C1C", "mascara": "lengthening black mascara", "brows": "soft natural arch", "tip": "keep eyes elegant and simple"},
        "party":      {"eyeshadow": "dark smoky black with bronze shimmer", "eyeshadow_hex": "#3D3835", "eyeliner": "black kajal + sharp winged black liner", "eyeliner_hex": "#0D0D0D", "mascara": "volumising black mascara", "brows": "bold defined brows", "tip": "blend well for a seamless smoky look"},
        "university": {"eyeshadow": "nude peach wash on lid", "eyeshadow_hex": "#CFA18C", "eyeliner": "black kajal in waterline", "eyeliner_hex": "#222222", "mascara": "lengthening mascara", "brows": "soft natural brows", "tip": "keep it light and natural"},
        "office":     {"eyeshadow": "neutral taupe on lid, ivory on brow bone", "eyeshadow_hex": "#99827B", "eyeliner": "thin black liner on upper lash line + black kajal", "eyeliner_hex": "#202020", "mascara": "lengthening black mascara", "brows": "neat arch", "tip": "avoid glitter for office looks"},
        "everyday":   {"eyeshadow": "light nude wash on lid", "eyeshadow_hex": "#CBB2A3", "eyeliner": "black kajal in waterline", "eyeliner_hex": "#252525", "mascara": "light black mascara", "brows": "natural brows lightly filled", "tip": "keep it simple and quick"},
        "date":       {"eyeshadow": "warm rose on lid with gold shimmer", "eyeshadow_hex": "#B56D73", "eyeliner": "black kajal + thin liner", "eyeliner_hex": "#1B1B1B", "mascara": "volumising black mascara", "brows": "defined soft arch", "tip": "a little shimmer on the lid makes eyes pop"},
    }

    # ── Lips ──────────────────────────────────────────────────
    lips_looks = {
        "wedding":    {"liner": "deep rose overlined", "lipstick": "deep rose satin", "shade_name": "Deep Rose", "hex": "#AC3B56", "gloss": "skip — long-lasting matte finish", "tip": "blot and reapply for all-day wear"},
        "mehndi":     {"liner": "bright orange-red liner", "lipstick": "bright orange-red matte", "shade_name": "Tangerine Blaze", "hex": "#E0412B", "gloss": "skip gloss", "tip": "bold lips complete the mehndi look"},
        "dholki":     {"liner": "hot pink liner", "lipstick": "hot pink matte or satin", "shade_name": "Hot Fuchsia", "hex": "#D1246C", "gloss": "clear gloss on centre for fun", "tip": "match lip colour to your outfit accent"},
        "eid":        {"liner": "nude pink liner", "lipstick": "soft rose satin", "shade_name": "Petal Rose", "hex": "#C95B72", "gloss": "clear gloss for shine", "tip": "keep lips soft and elegant"},
        "party":      {"liner": "dark berry liner", "lipstick": "bold red or berry matte", "shade_name": "Berry Bold", "hex": "#8B1E3F", "gloss": "skip — bold matte finish", "tip": "bold lips or bold eyes — not both"},
        "university": {"liner": "nude liner", "lipstick": "light nude pink", "shade_name": "Bare Blush", "hex": "#D67D89", "gloss": "clear gloss or tinted balm", "tip": "tinted lip balm is perfect for quick looks"},
        "office":     {"liner": "mauve liner", "lipstick": "mauve satin", "shade_name": "Muted Mauve", "hex": "#A75D6E", "gloss": "very light gloss", "tip": "mauve and nude shades are professional"},
        "everyday":   {"liner": "nude liner", "lipstick": "sheer pink or tinted balm", "shade_name": "Sheer Blush", "hex": "#DC7C85", "gloss": "clear gloss", "tip": "keep lips moisturised and natural"},
        "date":       {"liner": "rose liner", "lipstick": "coral rose satin", "shade_name": "Coral Kiss", "hex": "#D84F5F", "gloss": "clear gloss on centre", "tip": "a glossy centre lip looks romantic and full"},
    }
